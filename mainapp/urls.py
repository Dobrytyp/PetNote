...
from mainapp.views import mypage, logout, all_pets, main, logged_new_pet, logged_edit_pet, logged_delete_pet, google_account, registration, new_account, all_accounts,edit_account, delete_account, new_pet, edit_pet, delete_pet, new_visit, all_visits, edit_visit, delete_visit
